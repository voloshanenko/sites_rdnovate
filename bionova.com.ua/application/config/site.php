...
$config["front_title"]="BioNova";
$config["front_keywords"]="BioNova";
$config["front_description"]="BioNova";
$config["ad_exp_header"]="Бионова-товары для дома и семьи.";
