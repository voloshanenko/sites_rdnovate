...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,doc,docx,xls,xlsx,pdf,zip,rar'); // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,doc,docx,xls,xlsx,pdf,zip,rar');
