<?php
/**
* @version $Id: admin.config.class.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
...
class adminConfig extends sobi2Config {
    ...
    function adminConfig()
    {
    	...
    	if(!file_exists("{$this->absolutePath}".DS."administrator".DS."components".DS."com_sobi2".DS."images".DS."sobi2_logo150.png")) {
    		die("error 2809-L");
    	}
    ...
    {
    	$database =& $this->getDb();
    	$configValue = $database->getEscaped( $configValue );
		if(!$this->checkPerm()) {
			$this->noPerms();
		}
		if(!$section) {
