<?php
/**
* @version $Id: admin.sobi2.class.html.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
	...
	function buildForm($returnTask = 'listing',$catId = 1)
	{
    	...
    	if( $config->key( "edit_form", "cats_selection_adm", true ) ) {
			...
			if($config->allowUsingImg == 2){
				...
				$blabber = "administrator/components/com_sobi2/images/nfo.png";
				$notFreeImg = sobiHTML::toolTip( $nfo_txt, _SOBI2_FORM_NOT_FREE_OPTION, null, $blabber, "" );
			}
			else {
				$notFreeImg = null;
			}
			if($config->allowUsingIco == 2){
				...
				$blabber = "administrator/components/com_sobi2/images/nfo.png";
				$notFreeIco = sobiHTML::toolTip( $nfo_txt, _SOBI2_FORM_NOT_FREE_OPTION, null, $blabber, "" );
			}
		 ...
		 */
			...
			switch ($field->fieldType) {
				...
				case 2: // is textarea
					...
					break;
				case 5: //is list
					$this->jsValidator = $this->jsValidator."\n\t\t else if (form.{$field->fieldname}.selectedIndex == -1 && pressbutton != 'cancel') {" .
										"\n\t\t\t alert( '"._SOBI2_FORM_JS_ALL_REQUIRED_FIELDS."' );" .
										"\n\t\t }";
					break;
				case 6: // is textfield
