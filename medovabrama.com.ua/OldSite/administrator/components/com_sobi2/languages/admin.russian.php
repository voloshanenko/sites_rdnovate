<?php
/**
 * @version	$Id: admin.russian.php 5237 2009-07-13 14:16:40Z Sigrid Suski $
 * @package	SOBI2
...
DEFINE('_SOBI2_CONFIG_ENTRY_NOTIFY_AUTHOR_RENEW_EXPL', 'Отправлять подтверждение на em-ail клиенту/автору о продлении его записи.');
...
DEFINE('_SOBI2_CONFIG_L3CACHE_EXPL', '<b>Кеш третьего уровня</b> - кеширование объектов. Этот кеш будет обновлен для каждого объекта, если запись или категория были изменены.');
...
DEFINE('_SOBI2_CONFIG_GENERAL_SHOW_SUBCATS_UNDER_CAT', 'Показывать список категорий');
...
DEFINE('_SOBI2_CONFIG_ENTRY_WS_HEADER', 'Выбор направления поиска');
...
DEFINE('_SOBI2_CONFIG_GENERAL_EXSEARCH_SLIDER_FADE_ON_START', 'Стирать при запуске');
...
DEFINE('_SOBI2_CONFIG_GENERAL_EXSEARCH_SLIDER_FADE_AFTER_SEARCH', 'Стирать после поиска');
...
DEFINE('_SOBI2_CONFIG_CACHE_EMPTY', 'Кеш пуст');
...
DEFINE('_SOBI2_MENU_EMAILS', 'Шаблон сообщений');
