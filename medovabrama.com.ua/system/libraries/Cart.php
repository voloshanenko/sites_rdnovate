...
class CI_Cart {
	...
	var $product_id_rules	= '\.А-Яа-яёЁA-Za-z0-9_-'; // alpha-numeric, dashes, underscores, or periods
	var $product_name_rules	= '\.\:\-_ А-Яа-яёЁA-Za-z0-9'; // alpha-numeric, dashes, underscores, colons or periods
