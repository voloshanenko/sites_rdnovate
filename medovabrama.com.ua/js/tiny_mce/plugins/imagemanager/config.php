<?php
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,pdf,doc,xls";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,pdf,doc,xls";
