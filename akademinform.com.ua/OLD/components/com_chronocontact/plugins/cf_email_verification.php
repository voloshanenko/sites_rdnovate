...
class cf_email_verification  {
	...
	<table border="0" cellpadding="3" cellspacing="0">
    	<?php
			$tables = $database->getTableList();
			$tables_array = array('' => JHTML::_('select.option', JText::_('--?--')));
        ...
        <tr style="background-color:#c9c9c9 ">
			...
			<td><strong><?php echo "Form DB table"; ?>:</strong> </td>
			<td></td>
			<td>
            <?php echo JHTML::_('select.genericlist', $tables_array, "params[vtablename]", array(), 'value', 'text', $paramsvalues->get('vtablename'), '', ''); ?>
            </td>
		</tr>
        <tr style="background-color:#c9c9c9 ">
