	...
	function onAfterRender()
	{
		...
		if ($iebrowser) {
			if (file_exists($localFolder . "/$theme/rokbox-style-ie$iebrowser.php")) {
				echo "<link href=\"" . $remoteFolder . "/$theme/rokbox-style-ie$iebrowser.php\" rel=\"stylesheet\" type=\"text/css\" />\r\n";
			}
			elseif (file_exists($localFolder . "/$theme/rokbox-style-ie$iebrowser.css")) {
				echo "<link href=\"" . $remoteFolder . "/$theme/rokbox-style-ie$iebrowser.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n";
			}
		}
