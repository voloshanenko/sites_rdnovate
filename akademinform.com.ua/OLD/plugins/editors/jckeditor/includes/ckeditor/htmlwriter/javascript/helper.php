...
class JCKJavascriptHelper
{
	function getHeadJavascript(&$params,&$errors,&$excludeEventHandlers)
	{
		...
		//clean name attrtibute incase of illegal chararters
		$editorname  = JCKOutput::cleanString($editorname);
		...
		*/
		...
		"window.addEvent(\"domready\",function() 
		{
			CKEDITOR.on('instanceCreated',function(evt)
			{
				 ...
				 CKEDITOR.tools.extend( CKEDITOR.jinstance, 
				{
	 ...
	 {
		return "CKEDITOR.jinstance.getData('$editor');";
	 }
