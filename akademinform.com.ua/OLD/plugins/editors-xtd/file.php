<?php
/**
 * @version		$Id: file.php 12542 2009-07-22 17:40:48Z ian $
 * @package		Joomla
 ...
 * @since 1.5
 */
class plgButtonFile extends JPlugin
{
	/**
	 * Constructor
	 *
	 ...
	 * @since 1.5
	 */
	function plgButtonFile(& $subject, $config)
	{
	...
	function onDisplay($name)
	{
		...
		$link = 'index.php?option=com_media&amp;view=files&amp;tmpl=component&amp;e_name='.$name;
