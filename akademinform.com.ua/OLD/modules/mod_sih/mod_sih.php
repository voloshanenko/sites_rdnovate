...
{
echo "\n<!-- Simple Image Holder 1.5.9 starts here -->\n<div style='text-align:$align;'>";
if (substr($file, strlen($file)-4, strlen($file))!=".swf")
	{
	$id	= "sih".(int)(microtime()*10000);
...
if (SIH_FlashCanPlay)
	...
	'width','$width','height','$height','WMode','opaque'".(($name!='') ? ",'id','$name'" : "").",'src','$root$file','quality','$quality'".
	(($wmode!='window') ? ",'wmode','opaque'" : "").(($loop=='no') ? ",'loop','false'" : "").
...
echo "</div>\n<!-- Simple Image Holder 1.5.9 ends here -->\n";
}
?>