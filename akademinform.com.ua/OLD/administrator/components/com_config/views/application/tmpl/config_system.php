...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		...
		<tbody>
			...
			<td class="key">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Domain' ); ?>::<?php echo JText::_( 'TIPDOMAIN' ); ?>">
					<?php echo JText::_( 'Domain' ); ?>
				</span>
			</td>
			<td>
				<input class="text_area" type="text" size="50" name="domain" value="<?php echo $row->domain; ?>" />
			</td>
		</tr>
		</tbody>
	</table>
