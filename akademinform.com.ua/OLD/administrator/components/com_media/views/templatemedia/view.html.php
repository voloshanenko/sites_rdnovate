 ...
 * @since 1.0
 */
class MediaViewTemplatemedia extends JView
{
	function display($tpl = null)
	{
		...
		$document->addScript('components/com_media/assets/templatemediamanager.js');
		$document->addStyleSheet('components/com_media/assets/templatemediamanager.css');
	...
	function _setToolBar()
	{
		...
		JToolBarHelper::title( JText::_( 'Template images manager' ), 'template-img.png');
