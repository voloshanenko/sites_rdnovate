<?php defined('_JEXEC') or die('Restricted access'); ?>
		<div class="imgOutline">
			...
			<div class="imginfoBorder">
				<a href="index.php?option=com_media&amp;view=templatemediaList&amp;tmpl=component&amp;view=templatemediaList&amp;template=1&amp;folder=<?php echo $this->_tmp_folder->path_relative; ?>" target="folderframe"><?php echo substr( $this->_tmp_folder->name, 0, 10 ) . ( strlen( $this->_tmp_folder->name ) > 10 ? '...' : ''); ?></a>
			</div>
		</div>