 ...
 * @since 1.0
 */
class MediaViewFilesList extends JView
{
	function display($tpl = null)
	{
		...
		JHTML::_('stylesheet', 'popup-filelist.css', $append .'components/com_media/assets/');

		$document =& JFactory::getDocument();
		$document->addScriptDeclaration("var FileManager = window.parent.FileManager;");
