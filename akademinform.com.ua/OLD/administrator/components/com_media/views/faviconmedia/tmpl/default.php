        ...
        <td>
            ...
            <form action="index.php?option=com_media&amp;task=folder.create" name="folderForm" id="folderForm" method="post">
                <fieldset id="folderview">
                    ...
                    <div class="view">
                        <iframe src="index.php?option=com_media&amp;view=faviconmediaList&amp;tmpl=component&amp;folder=<?php echo $this->state->folder;?>" id="folderframe" name="folderframe" width="100%" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0"></iframe>
                    </div>
                </fieldset>
			...
			<?php if ($canUpload) : ?>
				<form action="<?php echo JURI::base(); ?>index.php?option=com_media&amp;task=file.upload&amp;tmpl=component&amp;<?php echo $this->session->getName().'='.$this->session->getId(); ?>&amp;favicon=1&amp;<?php echo JUtility::getToken();?>=1" id="uploadForm" method="post" enctype="multipart/form-data">
					<fieldset>
					...
					<input type="hidden" name="return-url" value="<?php echo base64_encode('index.php?option=com_media&view=faviconmedia&e_name='.JRequest::getCmd('e_name')); ?>" />
				</form>
			<?php endif; ?>
        </td>
    </tr>
