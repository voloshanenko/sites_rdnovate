 ...
 * @since 1.0
 */
class MediaViewFaviconmedia extends JView
{
	function display($tpl = null)
	{
		...
		$document->addScript('components/com_media/assets/faviconmediamanager.js');
		$document->addStyleSheet('components/com_media/assets/faviconmediamanager.css');
	...
	function _setToolBar()
	{
		...
		JToolBarHelper::title( JText::_( 'Favicon manager' ), 'favicon.png');
