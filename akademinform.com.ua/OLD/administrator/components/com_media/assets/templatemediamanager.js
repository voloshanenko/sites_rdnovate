...
var MediaManager = {
    ...
    initialize: function()
    {
        ...
        this.tree = new MooTreeControl({ div: 'media-tree_tree', mode: 'folders', grid: true, theme: 'components/com_media/assets/mootree.gif', onClick:
            ...
            },{ text: 'Media', open: true, data: { url: 'index.php?option=com_media&view=templatemediaList&tmpl=component', target: 'folderframe'}});
    ...
    setViewType: function(type)
    {
        ...
        viewstyle = type;
        var folder = this.getFolder();
        this._setFrameUrl('index.php?option=com_media&view=templatemediaList&tmpl=component&folder='+folder+'&layout='+type);
    },
