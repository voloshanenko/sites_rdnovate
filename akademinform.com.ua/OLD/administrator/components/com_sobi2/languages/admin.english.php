<?php
/**
* @version $Id: admin.english.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
...
define('_SOBI2_MENU_ABOUT', 'About System');
define('_SOBI2_MENU_ABOUT_SOBI', 'About Sigsiu.NET');

define('_SOBI2_SYSTEM', 'System');
...
define('_SOBI2_CONFIG_L3CACHE_EXPL', '<b>Third Level Cache</b> - Caching of object attributes. This cache will be refreshed for each object, if the entry/category has been changed. Do not set cache size to 0. It is needed for category count.');
 ...
 */
DEFINE('_SOBI2_MENU_EULA', 'License Agreement');
