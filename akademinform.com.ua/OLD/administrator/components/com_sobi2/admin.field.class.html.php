<?php
/**
* @version $Id: admin.field.class.html.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
    	...
    	function addListCSV( close ) {
			...
			<table class="SobiAdminForm">
				...
				<tr class="row0">
					...
					<td style="vertical-align: top !important;" width="30%"><input type="text" name="field_name" value="<?php echo $field->fieldname; ?>" size="20" maxlength="40" class="text_area" <?php if(!$field->isNameEditable) echo "disabled"?>/></td>
