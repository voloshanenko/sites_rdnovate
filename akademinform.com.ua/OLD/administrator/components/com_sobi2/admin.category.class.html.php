<?php
/**
* @version $Id: admin.category.class.html.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
					...
					<td valign="top" width="70%">
						<table class="SobiAdminForm">
							...
							<tr>
								...
								<td width="70%" ><input class="text_area" type="text" name="name" value="<?php echo $category->name; ?>" size="30" maxlength="250" /></td>
							</tr>
							<tr>
					...
					<table class="SobiAdminForm" width="100%">
						...
						<tr>
							...
							<td width="30%" style="vertical-align:top; height:100px" rowspan="2">
								...
								document.write('<img src=' + jsimg + ' name="imagelib" width="80" height="80" style="border-none;" alt="Preview" />');
								</script>
							</td>
						</tr>
						<tr>
