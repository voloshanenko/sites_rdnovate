<?php
/**
* @version $Id: syscheck.default.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
...
defined('_SOBI2SC_STATE_3') or define('_SOBI2SC_STATE_3', '<span style="color: rgb(153, 153, 0); font-weight: bold;">Should be OK</span>');
...
defined('_SOBI2SC_STATE_6') or define('_SOBI2SC_STATE_6', '<span style="color: rgb(255, 0, 0);">Should work but the folder is writable for <b>ALL</b><br/>Possible <b>security risk</b></span>');
defined('_SOBI2SC_STATE_7') or define('_SOBI2SC_STATE_7', '<span style="color: rgb(255, 0, 0);">Should work but the file is writable for <b>ALL</b><br/>Possible <b>security risk</b></span>');
...
defined('_SOBI2SC_FILES_PERMS') or define('_SOBI2SC_FILES_PERMS', 'Folder and File Permissions');
defined('_SOBI2SC_FILENAME') or define('_SOBI2SC_FILENAME', 'Folder or File Name');
