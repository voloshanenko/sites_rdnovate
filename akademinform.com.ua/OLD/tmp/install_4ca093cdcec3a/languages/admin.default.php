<?php
/**
* @version $Id: admin.default.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
 ...
 * added (RC 2.9.2)
 */
defined('_SOBI2_MENU_ABOUT') or define('_SOBI2_MENU_ABOUT', 'About System');
defined('_SOBI2_MENU_ABOUT_SOBI') or define('_SOBI2_MENU_ABOUT_SOBI', 'About Sigsiu.NET');
defined('_SOBI2_SYSTEM') or define('_SOBI2_SYSTEM', 'System');
...
defined('_SOBI2_CONFIG_L3CACHE_EXPL') or define('_SOBI2_CONFIG_L3CACHE_EXPL', '<b>Third Level Cache</b> - Caching of object attributes. This cache will be refreshed for each object, if the entry/category has been changed. Do not set cache size to 0. It is needed for category count.');
...
defined('_SOBI2_ABOUT_PBY_SUPPORT') or define('_SOBI2_ABOUT_PBY_SUPPORT', '<br /><strong>If you remove the "powered by" Link from our component, it is fair to donate for the component.</strong><br /><br />Developing and maintaining Sobi2 is a lot of work which should be recompensed adequately.<br />Click on the donate button below to donate via Paypal.<br /><br /><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=sigsiu%2enet%40sigsiu%2enet&item_name=Sobi2&item_number=Sobi2-CAB&no_shipping=2&lc=US&no_note=1&tax=0&currency_code=EUR&bn=PP%2dDonationsBF&charset=UTF%2d8" title="Donate for Sobi2" target="_blank"><img src="components/com_sobi2/images/donate_button.png" alt="Donate for Sobi2 via Paypal" title="Donate for Sobi2 via Paypal" border="0"/></a><br /><br />Thank you.<br /><br />');
 ...
 */
defined('_SOBI2_MENU_EULA') or define('_SOBI2_MENU_EULA', 'License Agreement');
