<?php
/**
* @version $Id: admin.sobi2.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
 ...
 * This function is used wenn Sobi2 works under PHP < 5
...
if( isset( $task ) ) {
	switch( $task ) {
		...
		case 'reorderPlugins':
	 	...
	 	case '_stats':
			sobi2Config::import( 'includes|stats', 'adm' );
			sobi2Stats::stats();
	 		break;
...
/*
if( !$config->ssrs && $task != '_'.'st'.'ats' ) {
	$buf = ob_get_contents();
	$buf = trim( $buf );
	if( !strstr( $buf, 'color:#D4D4D4; font-size: 15px' ) ) {
		ob_clean();	 $f = 'bas'.'e6'.'4_d'.'ec'.'ode';
		echo $f( '' );
		echo $buf;
	}
}
*/
