<?php /* Smarty version 2.6.18, created on 2010-12-21 16:24:33
         compiled from main/searchCompanyResult.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'main/searchCompanyResult.tpl', 38, false),array('modifier', 'date_format', 'main/searchCompanyResult.tpl', 282, false),array('modifier', 'htmlspecialchars', 'main/searchCompanyResult.tpl', 303, false),array('modifier', 'trim', 'main/searchCompanyResult.tpl', 332, false),array('modifier', 'many_emails', 'main/searchCompanyResult.tpl', 352, false),)), $this); ?>
...
var nowPage = "searchCompany?mode=<?php echo $this->_tpl_vars['mode']; ?>
...
<?php if ($_SESSION['auth']['is_super_user'] && $this->_tpl_vars['nowLocation'] == "все"): ?>
...
?>
		<?php if ($this->_tpl_vars['cur']['id'] == $this->_tpl_vars['managerFilter']): ?>
			<b><?php echo $this->_tpl_vars['cur']['nickname']; ?>
 /</b>
		<?php endif; ?>	
<?php endforeach; endif; unset($_from); ?>
<?php endif; ?>
<b><?php echo $this->_tpl_vars['nowLocation']; ?>
</b> [<?php echo $this->_tpl_vars['recordsFound']; ?>
]
</div>
<?php if (sizeof ( $this->_tpl_vars['companyList'] ) != 0): ?>
<div class="cListPrint">
<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/printer/companiesList?mode=<?php echo $this->_tpl_vars['mode']; ?>
&mparam=<?php echo $this->_tpl_vars['mparam']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
" class="cListPrintLink" target="_blank"><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>печать списка<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>
</div>
<?php endif; ?>
...
<tr>
  ...
  <td colspan="2" nowrap>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="/<?php echo $this->_tpl_vars['controller']; ?>
?mode=<?php echo $this->_tpl_vars['mode']; ?>
&mparam=<?php echo $this->_tpl_vars['mparam']; ?>
...
<?php if ($this->_tpl_vars['help']['7']): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "help/doc7.tpl", 'smarty_include_vars' => array()));
...
&mparam=<?php echo $this->_tpl_vars['mparam']; ?>
" class="pagesAllList" onclick="if (<?php echo $this->_tpl_vars['pages']; ?>
>50 && !confirm('Вывод всех данных может выполняться долго!\nВы уверены?')) return false;"><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>весь список<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a> 
  </td>
</tr>
<tr>
