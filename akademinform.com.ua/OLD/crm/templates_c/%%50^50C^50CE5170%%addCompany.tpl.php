<?php /* Smarty version 2.6.18, created on 2010-12-21 16:25:12
         compiled from main/addCompany.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'main/addCompany.tpl', 2, false),)), $this); ?>
...
<b><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Добавление новой компании<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></b>
...
/js/blocking.js"></script>




<form method="POST" action="<?php echo $this->_tpl_vars['siteurl']; ?>
/main/addCompanySubmit" onsubmit="activateDisable()">

<table border="0" width="1000"  cellpadding="0" cellspacing="0">
<tr>
<td width="710" valign="top">

<div class="company" style="margin:0px 40px 0px 40px; padding:12px 15px 12px 15px; width:590px; <?php if (! $this->_tpl_vars['help']['13']): ?>background-image:url('<?php echo $this->_tpl_vars['siteurl']; ?>
/images/creature1.gif');<?php endif; ?>background-repeat:no-repeat; background-position:right 100px;">
...
<?php if ($this->_tpl_vars['help']['13']): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "help/doc13.tpl", 'smarty_include_vars' => array()));
...
<?php if ($this->_tpl_vars['help']['13']): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "help/doc14.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['help']['13']): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "help/doc15.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<div style="float:right"><input type="submit" value="<?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Добавить<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" id="lockButton" style="background-color:#68c248;font-family:arial;font-size:16px;color:#fff;font-weight:bold;border-bottom:1px solid #2c6d15;border-right:1px solid #2c6d15"></div>
<div id="clear"></div>
