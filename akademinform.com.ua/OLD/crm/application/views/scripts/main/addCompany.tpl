...
<b>{t}Добавление новой компании{/t}</b>
...
<script src="{$siteurl}/js/blocking.js"></script>




<form method="POST" action="{$siteurl}/main/addCompanySubmit" onsubmit="activateDisable()">

<table border="0" width="1000"  cellpadding="0" cellspacing="0">
<tr>
<td width="710" valign="top">

<div class="company" style="margin:0px 40px 0px 40px; padding:12px 15px 12px 15px; width:590px; {if !$help.13}background-image:url('{$siteurl}/images/creature1.gif');{/if}background-repeat:no-repeat; background-position:right 100px;">
...
<div style="float:right"><input type="submit" value="{t}Добавить{/t}" id="lockButton" style="background-color:#68c248;font-family:arial;font-size:16px;color:#fff;font-weight:bold;border-bottom:1px solid #2c6d15;border-right:1px solid #2c6d15"></div>
<div id="clear"></div>
