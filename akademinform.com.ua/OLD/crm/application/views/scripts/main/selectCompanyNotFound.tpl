...
var nowPage = "selectCompanyNotFound?company={$selectedCompany}&page={$page}";
...
<a href="{$siteurl}/main/addCompany?name={$company}" class="cLink">{t}Добавить?{/t}</a>
</span>
...
<script type="text/javascript">
    var pFrom   = 1,
        ...
        curPage = {$page},
        timer, timer2,
        page = '{$siteurl}/main/selectCompanyNotFound?company={$company}&page=';
</script>
...
<tr>
  ...
  <td colspan="2" nowrap>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="{$siteurl}/main/selectCompanyNotFound?company={$company}" class="pagesAllList"  onclick="if ({$pages}>50 && !confirm('{t}Вывод всех данных может выполняться долго!\nВы уверены?{/t}')) return false;">{t}весь список{/t}</a>   
  </td>
</tr>
<tr>
...
{else}
	...
	{if $smarty.section.name.index==$page} 
		...
		{else}
		<span class="pageInactive"><a href="{$siteurl}/main/selectCompanyNotFound?company={$company}&page={$smarty.section.name.index}" class="pageInactiveLink">{$smarty.section.name.index}</a></span>
		{/if}
	{/section}
	&nbsp;&nbsp;&nbsp;
	<a href="{$siteurl}/main/selectCompanyNotFound?company={$selectedCompany}" class="pagesAllList">{t}весь список{/t}</a>
{/if}
...
{else}
	...
	{if $smarty.section.name.index==$page} 
		<span class="pageActive">{$smarty.section.name.index}</span>
		{else}
		<span class="pageInactive"><a href="/main/selectCompanyNotFound?company={$company}&page={$smarty.section.name.index}" class="pageInactiveLink">{$smarty.section.name.index}</a></span>
		{/if}
	{/section}
	&nbsp;&nbsp;&nbsp;
	<a href="{$siteurl}/main/selectCompanyNotFound?company={$company}" class="pagesAllList">{t}весь список{/t}</a>
{/if}
