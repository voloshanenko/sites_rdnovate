...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Главная', 'url'=>'http://akademinform.com.ua/'),
	...
	<div class="general-padding footer">
		...
		<div id="footer" class="upperlined html-box">
			...
			<p>Интеграция © 2012.<br />
			Все права защищены.<br />
			При копировании материалов, активная ссылка на источник (<a href="http://akademinform.com.ua/">akademinform.com.ua/</a>) - обязательна!</p>
		</div>
