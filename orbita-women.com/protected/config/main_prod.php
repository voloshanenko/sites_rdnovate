...
return array(
	...
	'components'=>array(
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=orbitawomen',
			'emulatePrepare' => true,
			'username' => 'u_orbitawomen',
			'password' => 'yS4fxbTi',
			'charset' => 'utf8',
    ...
    'params'=>array(
    	...
    	'contestsPerPage' => 5,
    	'adsPerPage' => 40,
        'defaultMetaTitle' => 'Женские Орбиты, женское здоровье, женская красота, диета, похудение, кулинарные рецепты, советы для женщин, товары для женщин, правильное питание, вязание',
        'defaultMetaKeywords'=>'женское здоровье, женская красота, диета, похудение, кулинарные рецепты, советы для женщин, товары для женщин, правильное питание, вязание',
        'defaultMetaDescription'=>'Женские Орбиты',
        'spam'=>array(
            'fromEmail'=>'noreply@orbita-women.com',
            'fromName'=>'Женские Орбиты',
        ),
        'adminEmail'=>'noreply@orbita-women.com',
