...
<div class="container" id="page">
	...
	<div class="general-padding underlined">
		<div id="bionova_placeholder">Загрузка...</div>
		<script>window.onload=function(){setTimeout(function(){$.getScript('http://bionova.com.ua/js/export.js');},1000)}</script>
	</div>
	<?php } ?>
	...
	<div class="general-padding footer">
		...
		<div id="footer" class="upperlined html-box">
			...
			<p><?=Yii::app()->name?> © 2012.<br />
			Все права защищены.<br />
			При копировании материалов, активная ссылка на источник (<a href="http://orbita-women.com/">orbita-women.com</a>) - обязательна!</p>
		</div>
