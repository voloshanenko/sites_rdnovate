...
class SiteController extends Controller
{
	...
	{
		//$this->sendErrorReport(Yii::app()->errorHandler->error);
	...
	private function sendErrorReport($e)
	{
		Yii::import('application.helpers.CWebTools');
		CWebTools::sendEmailAsSiteRobot('raqy.style@gmail.com', 'Ivan', $_SERVER["SERVER_NAME"].': Error', 'error', array(
