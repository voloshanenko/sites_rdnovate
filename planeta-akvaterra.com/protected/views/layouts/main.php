...
<div class="container" id="page">
	...
	<div class="general-padding underlined">
		...
		<script> 
		window.onload=function(){setTimeout(function(){$.getScript('http://akvariumistika-nova.com.ua/js/export.js');},1000)}</script>
	</div>
	<?php } ?>
	...
	<div class="general-padding footer">
		...
		<div id="footer" class="upperlined html-box">
			...
			При копировании материалов, активная ссылка на источник (<a href="http://planeta-akvaterra.com/">planeta-akvaterra.com</a>) - обязательна!</p>
		</div>
