...
return array(
    ...
    'params'=>array(
    	...
    	'contestsPerPage' => 5,
    	'adsPerPage' => 40,
        'defaultMetaTitle' => 'Планета Пчелопром, пчеловодство в Украине, пчеловодство для начинающих, лечение пчел, болезни пчел, сайты пчеловодов, лекарства для пчел, обработка пчел, книги по пчеловодству, форумы пчеловодов, выставка по пчеловодству',
        'defaultMetaKeywords'=>'пчеловодство в Украине, пчеловодство для начинающих, лечение пчел, болезни пчел, сайты пчеловодов, лекарства для пчел, обработка пчел, книги по пчеловодству, форумы пчеловодов, выставка по пчеловодству',
        'defaultMetaDescription'=>'Сайт посвященный пчеловодству и пчелам.',
        'spam'=>array(
            'fromEmail'=>'noreply@planeta-pcheloprom.com/',
            'fromName'=>'Планета Пчелопром',
        ),
        'adminEmail'=>'noreply@planeta-pcheloprom.com/',
