...
<div class="container" id="page">
	...
	<div class="general-padding underlined">
		<div id="mb_placeholder">Загрузка...</div>
		<script>
		window.onload=function(){setTimeout(function(){$.getScript('http://medovabrama.com.ua/js/export.js');},1000)}</script>
	</div>
	<?php } ?>
	...
	<div class="general-padding footer">
		...
		<div id="footer" class="upperlined html-box">
			...
			<p>Планета Пчелопром © 2012.<br />
			Все права защищены.<br />
			При копировании материалов, активная ссылка на источник (<a href="http://planeta-pcheloprom.com">planeta-pcheloprom.com</a>) - обязательна!</p>
		</div>
