...
<head>
    ...
    <meta name="google-translate-customization" content="8fe36cc66530dd4c-7c17a26bf51360bf-g9ebd89965c3ea2b9-13"></meta>
</head>
...
<div class="container" id="page">
	<div id="header" class="container">
		<!--<a id="logo" href="/" style="display: none;"><?php echo CHtml::image('/images/Design/logo.png', CHtml::encode(Yii::app()->name)); ?></a>-->
		<div id="search">
		...
		<!--<a id="second-logo" href="/"></a>-->
	</div><!-- header -->
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Главная', 'url'=>'http://planeta-pischeprom.com/'),
				array('label'=>'Объявления', 'url'=>array('/ads'), 'items'=>array(
					array('label'=>'Добавить объявление', 'url'=>array('/ads/default/create')),
				)),
				...
				array('label'=>'Фотосеты', 'url'=>array('/photos/item/'), 'items'=>array(
					array('label'=>'Будущие Фотосеты', 'url'=>array('/photos/item/future')),
					array('label'=>'Окончившиеся Фотосеты', 'url'=>array('/photos/item/past')),
	...
	<div class="general-padding footer">
		...
		<div id="footer" class="upperlined html-box">
			...
			<p>Планета Пищепром © 2012.<br />
			Все права защищены.<br />
			При копировании материалов, активная ссылка на источник (<a href="http://planeta-pischeprom.com/">planeta-pischeprom.com</a>) - обязательна!</p>
		</div>
